    ...
    <div class="ml-64 flex-grow flex flex-col">
      ...
      <main class="flex-grow p-6">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <!-- Card 1 -->
          <div class="bg-gray-50 dark:bg-gray-800 shadow-md rounded-lg p-4">
          <?php include '../controladores/dashboard/numpersonas.php'; ?>
          ...
          <!-- Card 2 -->
          <div class="bg-gray-50 dark:bg-gray-800 shadow-md rounded-lg p-4">
          <?php include '../controladores/dashboard/numcasas.php'; ?>
          ...
          <!-- Card 3 -->
          <div class="bg-gray-50 dark:bg-gray-800 shadow-md rounded-lg p-4">
          <?php include '../controladores/dashboard/numfamilias.php'; ?>
          ...
          <div class="bg-gray-50 dark:bg-gray-800 shadow-md rounded-lg p-4">
          <?php include '../controladores/dashboard/numbeneficios.php'; ?>
                    ...
                    <div class="overflow-hidden border border-gray-200 dark:border-gray-700 md:rounded-lg">
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                                <?php include '../controladores/dashboard/ultimoshabitantes.php'; ?>
                            </tbody>
                        </table>
                    </div>
                </div>
