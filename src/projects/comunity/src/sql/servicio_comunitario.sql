...
-- Tiempo de generación: 08-01-2025 a las 05:57:09
...
INSERT INTO `grupos_familiares` (`id_grupo_familiar`, `id_familia`, `id_persona`, `parentesco`, `jefe_familia`) VALUES
(1, 1, 1, 'Hijo(a)', 'No'),
(2, 2, 2, 'Hijo(a)', 'No'),
(3, 3, 3, 'Hijo(a)', 'No'),
(4, 2, 4, 'Madre', 'Si');
...
(1, 1, 'Jhon', '', 'Vasquez', 'Gomez', 'Venezolano', 31204020, 123456789, 123456787, 'Hombre', '2003-11-25', 0, '0424-542-1697', 'kacosvasquez14@gmail.com', '2024-07-26', 'Activo'),
