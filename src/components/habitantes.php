...
if (isset($_SESSION['id_usuario'])) {
    ...
    log_action($id_usuario, 'Acceso', 'Entró a la sección Habitantes');
} else {
                ...
                <section class="container px-4 mx-auto">
                    <div class="flex items-center justify-between border-b pb-2 mb-4">
                        ...
                        <div class="flex items-center mt-4 gap-x-3">
                            <button id="registerButton" class="flex items-center justify-center w-full px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-blue-500 rounded-lg shrink-0 sm:w-auto gap-x-2 hover:bg-blue-600 dark:hover:bg-blue-500 dark:bg-blue-600">
                                    ...
                                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                        ...
                                        <thead class="bg-gray-50 dark:bg-gray-800">
                                            <tr>
                                                ...
                                                <th class="px-4 py-3.5 text-center  font-normal text-left text-gray-500 dark:text-gray-400">Teléfono</th>
