...
if (isset($_SESSION['id_usuario'])) {
    ...
    log_action($id_usuario, 'Acceso', 'Entró a la sección Beneficios');
} else {
                                ...
                                <div
                                    ...
                                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                        ...
                                        <thead class="bg-gray-50 dark:bg-gray-800">
                                            <tr>
                                                <th class="py-3.5 px-4 text-center  font-normal text-left text-gray-500 dark:text-gray-400">Nombre de Beneficio</th>
                                                <th class="px-4 py-3.5 text-center  font-normal text-left text-gray-500 dark:text-gray-400">Familia</th>
                                                <th class="px-4 py-3.5 text-center  font-normal text-left text-gray-500 dark:text-gray-400">Numero de Manzana</th>
                                                <th class="px-12 py-3.5 text-center  font-normal text-left text-gray-500 dark:text-gray-400">Numero de Casa</th>
                                                <th class="px-12 py-3.5 text-center  font-normal text-left text-gray-500 dark:text-gray-400">Fecha Entregado</th>
                                                <th class="px-12 py-3.5 text-center  font-normal text-left text-gray-500 dark:text-gray-400">Observacion</th>
                                        </thead>
                                        <!--Filas-->
                        ...
                        fetch(`../components/beneficios/datos_entregas.php?id_casa=${idCasa}`)
                            ...
                            .then(data => {
                                ...
                                data.grupos_familiares.forEach(grupo => {
                                    ...
                                    option.textContent = `${grupo.nombre_familia} - ${grupo.nombre}`;
