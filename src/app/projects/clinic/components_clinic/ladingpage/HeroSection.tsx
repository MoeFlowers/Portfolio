            ...
            <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
                <div>
                    <h1 className="text-4xl md:text-5xl font-bold text-blue-900 leading-tight mb-6">
                        Excellence in <span className="text-cyan-600">Military Oral Health</span>
                    </h1>
                    <p className="text-lg text-gray-600 mb-8">
                        Specialized dental care for active military personnel, reserves and their families at IPSFA Barquisimeto.
                    </p>
