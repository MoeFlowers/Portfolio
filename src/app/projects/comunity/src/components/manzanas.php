                    ...
                    <div class="sm:flex sm:items-center sm:justify-between">
                        ...
                        <div>
                            <div class="flex items-center gap-x-3">
                                ...
                                <span class="px-3 py-1 text-xs text-blue-600 bg-blue-100 rounded-full dark:bg-gray-800 dark:text-blue-400">20 Registradas</span>
                            </div>
                                    ...
                                    <table
                                        ...
                                        <tbody
                                            ...
                                            <tr>
                                                ...
                                                <td
                                                    class="px-4 py-4  text-center text-sm font-medium whitespace-nowrap">
                                                    <div>
                                                        <h2
                                                            class="font-medium text-gray-800 dark:text-white">
                                                            1
                                                ...
                                                <td class="ml-4 px-4 py-4 text-sm whitespace-nowrap">
